...
/* harmony import */ var _logger_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../logger.js */ "./apps/files/src/logger.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup() {
    ...
    const buttons = [{
      ...
      type: 'primary',
      callback: nodes => {
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].debug('FileReferencePicker - Nodes picked', {
          nodes
        });
      }
    }];
  ...
  methods: {
    onClose(selectedNodes) {
      if (!selectedNodes || selectedNodes.length === 0) {
        ...
        const fileLink = "".concat(window.location.protocol, "//").concat(window.location.host).concat((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/f/{fileId}', {
          fileId: selectedNodes[0].fileid
        }));
...
/******/ })()
;
//# sourceMappingURL=files-reference-files.js.map?v=a17f50a422f8c336ac35