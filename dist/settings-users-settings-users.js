  ...
  methods: {
    ...
    resetForm() {
      ...
      if (this.settings.defaultLanguage) {
        vue__WEBPACK_IMPORTED_MODULE_7__["default"].set(this.newUser.language, 'code', this.settings.defaultLanguage);
      }
...
/* harmony import */ var _nextcloud_vue_dist_Components_NcAppNavigationNewItem_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcAppNavigationNewItem.js */ "./node_modules/@nextcloud/vue/dist/Components/NcAppNavigationNewItem.js");
/* harmony import */ var _nextcloud_vue_dist_Components_NcAppNavigationNewItem_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_nextcloud_vue_dist_Components_NcAppNavigationNewItem_js__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _nextcloud_vue_dist_Components_NcAppNavigationSettings_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcAppNavigationSettings.js */ "./node_modules/@nextcloud/vue/dist/Components/NcAppNavigationSettings.js");
/* harmony import */ var _nextcloud_vue_dist_Components_NcAppNavigationSettings_js__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_nextcloud_vue_dist_Components_NcAppNavigationSettings_js__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _nextcloud_vue_dist_Components_NcMultiselect_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcMultiselect.js */ "./node_modules/@nextcloud/vue/dist/Components/NcMultiselect.js");
/* harmony import */ var _nextcloud_vue_dist_Components_NcMultiselect_js__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_nextcloud_vue_dist_Components_NcMultiselect_js__WEBPACK_IMPORTED_MODULE_11__);
...
/* harmony import */ var _components_UserList_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../components/UserList.vue */ "./apps/settings/src/components/UserList.vue");
/* harmony import */ var vue_material_design_icons_Plus_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! vue-material-design-icons/Plus.vue */ "./node_modules/vue-material-design-icons/Plus.vue");
/* provided dependency */ var console = __webpack_require__(/*! ./node_modules/console-browserify/index.js */ "./node_modules/console-browserify/index.js");
...
vue__WEBPACK_IMPORTED_MODULE_16__["default"].use((vue_localstorage__WEBPACK_IMPORTED_MODULE_12___default()));
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'Users',
  components: {
    ...
    NcAppNavigationNewItem: (_nextcloud_vue_dist_Components_NcAppNavigationNewItem_js__WEBPACK_IMPORTED_MODULE_6___default()),
    NcAppNavigationSettings: (_nextcloud_vue_dist_Components_NcAppNavigationSettings_js__WEBPACK_IMPORTED_MODULE_7___default()),
    ...
    NcMultiselect: (_nextcloud_vue_dist_Components_NcMultiselect_js__WEBPACK_IMPORTED_MODULE_11___default()),
    Plus: vue_material_design_icons_Plus_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    UserList: _components_UserList_vue__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  props: {
    selectedGroup: {
      type: String,
  ...
  methods: {
    showNewUserMenu() {
      ...
      if (this.showConfig.showNewUserForm) {
        vue__WEBPACK_IMPORTED_MODULE_16__["default"].nextTick(() => {
...
var render = function render() {
  ...
  return _c("div", {
    ...
    attrs: {
      id: "app-content",
      role: "grid",
      "aria-label": _vm.t("settings", "User's table")
    },
    on: {
    ...
    staticClass: "modal__item managers",
    class: {
    ...
    attrs: {
      ...
      placeholder: _vm.t("settings", "Select user manager"),
      label: "displayname",
      "track-by": "id"
    },
    on: {
      "search-change": _vm.searchUserManager
    },
    model: {
    ...
    slot: "noResult"
  }, [_vm._v(_vm._s(_vm.t("settings", "No results")))])])], 1), _vm._v(" "), _c("div", {
...
var render = function render() {
  ...
  return Object.keys(_vm.user).length === 1 ? _c("div", {
    ...
    attrs: {
      for: "displayName" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Edit display name")))]), _vm._v(" "), _c("input", {
    ref: "displayName",
    attrs: {
    ...
    staticClass: "hidden-visually",
    attrs: {
      for: "password" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Add new password")))]), _vm._v(" "), _c("input", {
    ref: "password",
    attrs: {
    ...
    staticClass: "hidden-visually",
    attrs: {
      for: "mailAddress" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Add new email address")))]), _vm._v(" "), _c("input", {
    ref: "mailAddress",
    attrs: {
    ...
    staticClass: "hidden-visually",
    attrs: {
      for: "groups" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Add user to group")))]), _vm._v(" "), _c("NcMultiselect", {
    staticClass: "multiselect-vue",
    attrs: {
      id: "groups" + _vm.user.id + _vm.rand,
      "close-on-select": false,
      disabled: _vm.loading.groups || _vm.loading.all,
      limit: 2,
      multiple: true,
    ...
    staticClass: "hidden-visually",
    attrs: {
      for: "subadmins" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Set user as admin for")))]), _vm._v(" "), _c("NcMultiselect", {
    staticClass: "multiselect-vue",
    attrs: {
      id: "subadmins" + _vm.user.id + _vm.rand,
      "close-on-select": false,
    ...
    staticClass: "hidden-visually",
    attrs: {
      for: "quota" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Select user quota")))]), _vm._v(" "), _c("NcMultiselect", {
    staticClass: "multiselect-vue",
    attrs: {
      id: "quota" + _vm.user.id + _vm.rand,
      "allow-empty": false,
    ...
    staticClass: "hidden-visually",
    attrs: {
      for: "language" + _vm.user.id + _vm.rand
    }
  }, [_vm._v(_vm._s(_vm.t("settings", "Set the language")))]), _vm._v(" "), _c("NcMultiselect", {
    staticClass: "multiselect-vue",
    attrs: {
      id: "language" + _vm.user.id + _vm.rand,
      "allow-empty": false,
    ...
    attrs: {
      ...
      "user-select": true,
      options: _vm.possibleManagers,
      placeholder: _vm.t("settings", "Select manager"),
    ...
    on: {
      ...
      "search-change": _vm.searchUserManager,
      remove: _vm.updateUserManager,
      select: _vm.updateUserManager
    },
    model: {
    ...
    slot: "noResult"
  }, [_vm._v(_vm._s(_vm.t("settings", "No results")))])])], 1), _vm._v(" "), _vm.showConfig.showStoragePath || _vm.showConfig.showUserBackend ? _c("div", {
    staticClass: "storageLocation"
...
//# sourceMappingURL=settings-users-settings-users.js.map?v=aab1ee2395ca86d47ea1