  ...
  return _vm.statusesHaveLoaded ? _c("ul", {
    ...
    return _c("PredefinedStatus", {
      ...
      attrs: {
        ...
        selected: !_vm.isCustomStatus && _vm.lastSelected === status.id
      },
      on: {
...
var render = function render() {
  ...
  return _c("NcModal", {
    attrs: {
      size: "normal",
      title: _vm.$t("user_status", "Set status")
    },
    on: {
    ...
    attrs: {
      "is-custom-status": _vm.isCustomStatus
    },
    on: {
...
//# sourceMappingURL=user-status-modal-user-status-modal.js.map?v=ae8362e94bf602ed39ec