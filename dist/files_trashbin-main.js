...
/* harmony import */ var _files_src_services_FileAction_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../files/src/services/FileAction.ts */ "./apps/files/src/services/FileAction.ts");
...
/* harmony import */ var _nextcloud_paths__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @nextcloud/paths */ "./node_modules/@nextcloud/paths/dist/index.js");
/**
 * @copyright Copyright (c) 2023 John Molakvoæ <skjnldsv@protonmail.com>
 *
 * @author John Molakvoæ <skjnldsv@protonmail.com>
...
(0,_files_src_services_FileAction_ts__WEBPACK_IMPORTED_MODULE_7__.registerFileAction)(new _files_src_services_FileAction_ts__WEBPACK_IMPORTED_MODULE_7__.FileAction({
  id: 'restore',
  displayName() {
  ...
  async exec(node) {
    ...
    const encodedSource = origin + (0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_9__.encodePath)(node.source.slice(origin.length));
    try {
      var _getCurrentUser;
      const destination = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateRemoteUrl)((0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_9__.encodePath)("dav/trashbin/".concat((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_2__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid, "/restore/").concat(node.basename)));
...
const parseOriginalLocation = node => {
  ...
  const dir = (0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_6__.dirname)(path);
  if (dir === path) {
    // Node is in root folder
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_trashbin', 'All files');
  }
  return (0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_6__.joinPaths)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_trashbin', 'All files'), dir);
};
...
Navigation.register({
  ...
  columns: [{
    ...
    render(node) {
      ...
      const span = document.createElement('span');
      if (deletionTime) {
        span.title = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_3___default().unix(deletionTime).format('LLL');
        span.textContent = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_3___default().unix(deletionTime).fromNow();
        return span;
      }
...
/******/ })()
;
//# sourceMappingURL=files_trashbin-main.js.map?v=24eb4be3866eede07af1