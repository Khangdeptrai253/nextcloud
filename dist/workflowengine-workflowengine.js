...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    searchAsync(searchQuery) {
      ...
      return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_2__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateOcsUrl)('cloud/groups/details?limit=20&search={searchQuery}', {
        searchQuery
      })).then(response => {
...
var render = function render() {
  ...
  return _c("div", [_c("NcSelect", {
    attrs: {
      "aria-label-combobox": _vm.t("workflowengine", "Select groups"),
      "aria-label-listbox": _vm.t("workflowengine", "Groups"),
      clearable: false,
      loading: _vm.status.isLoading && _vm.groups.length === 0,
      placeholder: _vm.t("workflowengine", "Type to search for group …"),
      options: _vm.groups,
      value: _vm.currentValue,
      label: "displayname"
    },
    on: {
      search: _vm.searchAsync,
...
var render = function render() {
  ...
  return _c("div", {
    ...
    staticClass: "actions__item__description"
  }, [_c("h3", [_vm._v(_vm._s(_vm.t("workflowengine", "More flows")))])])]) : _vm._e()], 2), _vm._v(" "), _vm.hasMoreOperations ? _c("div", {
...
/******/ })()
;
//# sourceMappingURL=workflowengine-workflowengine.js.map?v=ff17628121f566fe6fb5