OC.L10N.register(
    ...
    "Temporary error" : "Ideiglenes hiba",
    ...
    "Between ${this.dateFilter.startFrom.toLocaleDateString()} and ${this.dateFilter.endAt.toLocaleDateString()}" : "${this.dateFilter.startFrom.toLocaleDateString()} és ${this.dateFilter.endAt.toLocaleDateString()} között",
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "Ez a Nextcloud nem támogatott közösségi kiadása. A példány mérete miatt a teljesítménye, megbízhatósága és skálázhatósága nem garantálható. A leküldéses értesítések korlátozottak, hogy ne terheljék túl az ingyenes szolgáltatásunkat. Tudjon meg többet a Nextcloud Enterprise előnyeiről a {linkstart}nextcloud.com/enterprise{linkend} oldalon.",
    ...
    "Accessing site insecurely via HTTP. You are strongly advised to set up your server to require HTTPS instead, as described in the {linkstart}security tips ↗{linkend}. Without it some important web functionality like \"copy to clipboard\" or \"service workers\" will not work!" : "A webhely elérése nem biztonságos HTTP-n keresztül. Javasoljuk, hogy úgy állítsa be a kiszolgálót, hogy követelje meg a HTTPS-t, amint azt a {linkstart}biztonsági tippek ↗{linkend} leírják. Enélkül egyes fontos webes funkciók, mint a vágólapra másolás és a service workerek nem fognak működni!",
