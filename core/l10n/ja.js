OC.L10N.register(
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "本サーバーはNextcloudのサポートがないコミュニティビルドで動いています。実行中の規模でのパフォーマンス、信頼性、スケーラビリティを保証するものではありません。プッシュ通知は無料サービスへ負荷がかからないように制限されています。Nextcloud Enterpriseのメリットについては、{linkstart}https://dkviet.com/enterprise{linkend}を参照してください。",
