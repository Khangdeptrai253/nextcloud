OC.L10N.register(
    ...
    "Please use the command line updater because you have a big instance with more than 50 accounts." : "Por favor, use o atualizador de linha de comando porque você tem uma grande instância com mais de 50 contas.",
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "Esta é a compilação da comunidade sem suporte do Nextcloud. Dado o tamanho desta instância, o desempenho, a confiabilidade e a escalabilidade não podem ser garantidos. As notificações push são limitadas para evitar sobrecarregar nosso serviço gratuito. Saiba mais sobre os benefícios do Nextcloud Enterprise em {linkstart}https://dkviet.com/enterprise{linkend}.",
