OC.L10N.register(
    ...
    "The account limit of this instance is reached." : "已达到这个实例的最大账户上限。",
    "Enter your subscription key in the support app in order to increase the account limit. This does also grant you all additional benefits that Nextcloud Enterprise offers and is highly recommended for the operation in companies." : "在支持应用中输入你的订阅秘钥以拓展账户数量限制。这也确保您可以体验到 Nextcloud Enterprise 额外优势，强烈建议在公司应用场景中启用订阅。",
    "Learn more ↗" : "了解更多 ↗",
    ...
    "Wrong login or password." : "错误的账号或密码",
    ...
    "Login with username or email" : "使用用户名或邮箱进行登录",
    ...
    "Reset password" : "重置密码",
    "If this account exists, a password reset message has been sent to its email address. If you do not receive it, verify your email address and/or Login, check your spam/junk folders or ask your local administration for help." : "如果账户存在，一封密码重置信息将会被发送至你的邮箱账户。如果你没有收到该邮件，请检查你的登录邮箱拼写是否正确，或检查邮件是否被归为垃圾邮件，或请求本地管理员以提供支持。",
    ...
    "Detailed logs" : "详细日志",
    "Update needed" : "需要更新",
    "Please use the command line updater because you have a big instance with more than 50 accounts." : "因为你拥有超过50个账户的应用实例，请使用命令行进行更新。",
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "这是一个不受支持的 Nextcloud 社区版构建。鉴于此实例的大小，其性能、可靠性与可拓展性无法得到保证。为了避免我们提供的免费服务负载过重，通知推送功能受到限制。请至 {linkstart}https://dkviet.com/enterprise{linkend} 获取更多关于企业版 Nextcloud 的资讯。",
