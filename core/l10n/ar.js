OC.L10N.register(
    ...
    "The account limit of this instance is reached." : "تم الوصول إلى الحد الأقصى من الحسابات على هذا الخادوم",
    ...
    "No" : "لا",
    "Yes" : "نعم",
    "Custom date range" : "نطاق زمني مُخصَّص",
    ...
    "The page could not be found on the server or you may not be allowed to view it." : "لم يُمكن إيجاد الصفحة على الخادوم أو ربما غير مسموح لك بالوصول إليها.",
    ...
    "Alternative log in using app password" : "تسجيل الدخول بطريقة بديلة باستعمال كلمة مرور التطبيق",
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "هذه نسخة مجتمعية من نكست كلاود. بسبب كبر حجم هذه التنصيبة من النظام فإن مستويات الأداء و الاعتمادية و التوسعية فيه لا يمكن ضمانها. حجم الإشعارات المبعوثة تمّ تقييده لئلّا تُرهق خدمتنا المجانية. للمزيد أنظر حول مزايا نسخة نكست كلاود المؤسسية في  {linkstart}https://dkviet.com/enterprise{linkend}.",
