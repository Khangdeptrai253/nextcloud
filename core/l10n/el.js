OC.L10N.register(
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "Αυτή είναι η μη υποστηριζόμενη κοινοτική έκδοση του Nextcloud. Δεδομένου του μεγέθους αυτής της εγκατάστασης, η απόδοση, η αξιοπιστία και η επεκτασιμότητα δεν μπορούν να εγγυηθούν. Οι ειδοποιήσεις push είναι περιορισμένες για να αποφευχθεί η υπερφόρτωση της δωρεάν υπηρεσίας μας. Μάθετε περισσότερα για τα οφέλη του Nextcloud Enterprise στη διεύθυνση {linkstart}https://dkviet.com/enterprise{linkend}.",
