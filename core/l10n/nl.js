OC.L10N.register(
    ...
    "Please use the command line updater because you have a big instance with more than 50 accounts." : "Gebruik alsjeblieft de commandoregel updater omdat je een installatie hebt met meer dan 50 gebruikers.",
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {linkstart}https://dkviet.com/enterprise{linkend}." : "Dit is een niet-ondersteunde communityversie van Nextcloud. Gezien de grootte van deze instantie kunnen goede prestaties, betrouwbaarheid en schaalbaarheid niet gegarandeerd worden. Pushmeldingen zijn gelimiteerd om overbelasting van de gratis instantie te voorkomen. Lees meer over de voordelen van Nextcloud Enterprise bij de volgende link: {linkstart}https://dkviet.com/enterprise{linkend}.",
